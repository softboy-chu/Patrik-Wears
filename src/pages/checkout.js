...
export default function Checkout() {
  return (
    ...
    <div className='m-4 bg-[#D9D9D9] p-4 flex flex-col rounded-2xl border-b-2 border-b-gray-500'>
      <div className='p-3 '>
        <p>Size 32</p>
      </div>
      <div className='p-3 '>
    ...
    <div className='m-4 bg-[#D9D9D9] flex flex-col rounded-2xl'>
      <div className='flex flex-row justify-between items-center bg-[#FCDDEC] p-4 rounded-t-2xl border-b-2 border-b-gray-500'>
        <div>
          <p>Delivery address</p>
        </div>
        <div className='bg-[#A5A6F6] p-1.5 rounded-2xl'>
      ...
      <div className='p-4 flex flex-row items-center gap-4 border-b-2 border-b-gray-500 rounded-b-xl'>
          ...
          <div className='bg-[#E8E8E8] p-1.5 w-4/5 rounded-2xl'>
            <input placeholder='08023456789'/>
          </div>
        </div>
    </div>
    <div className='flex flex-col m-4 bg-[#D9D9D9]'>
